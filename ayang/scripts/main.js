;(function (window) {
  ...
  let texts = ['PENCET DIMANA SAJA AY','JANGAN LUPA', 'PAKAI LANDSCAPE MODE', 'HEY', 'CAPEK YA', 'INGET KATA MS PENI', 'IKAN HIU KETATAP TIANG', 'I LOVE U SAYANG', 'HEHEHEHEHE', 'GAK LUCU YA', 'MAAF', 'KALO CAPEK ISTIRAHAT YA', 'JANGAN LUPA MAKAN ', 'JAGA KESEHATAN', 'KALO GAK DI JAGA NANTI CANTIKNYA HILANG LO', 'MANA SENYUMNYA', 'MAAF YA BELUM BISA MENGHIBURMU', 'NANTI CERITA YA KALO KAMU NGERASA GAK KUAT', 'AKU BAKAL ADA UNTUKMU', 'TERAKHIR', 'TERIMA KASIH ', 'I', 'LOVE', 'YOU ♡', 'DELA ASTRIA BUDIARTI', 'BYE', 'MAAFIN AKU YA', 'KALO AKUBELUM BISA BIKIN SENENG']
